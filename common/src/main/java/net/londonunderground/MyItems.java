...
public interface MyItems {
	...
	CreativeModeTabs.Wrapper TFL_STATION = new CreativeModeTabs.Wrapper(new ResourceLocation(MOD_ID, "tfl_staion"), () -> new ItemStack(MyBlocks.TFL_BLOCK.get()));
	...
	CreativeModeTabs.Wrapper TFL_LEGACY = new CreativeModeTabs.Wrapper(new ResourceLocation(MOD_ID, "tfl_legacy"), () -> new ItemStack(MyBlocks.TUBE_1.get()));
}
