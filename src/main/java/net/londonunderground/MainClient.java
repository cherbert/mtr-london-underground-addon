...
public class MainClient implements ClientModInitializer, IPacket {
    ...
    public void onInitializeClient() {
        ...
        BlockEntityRendererRegistry.INSTANCE.register(Main.BLOCK_ROUNDEL_STATION_TILE_ENTITY, RenderPlatformRoundelHolden::new);
        BlockEntityRendererRegistry.INSTANCE.register(Main.MORDEN_SIGN_TILE_ENTITY, RenderMordenRoundel::new);
