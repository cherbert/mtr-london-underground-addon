...
//import java.util.*;
//
//public class RenderPIDSold<T extends BlockEntity> extends BlockEntityRenderer<T> implements IGui {
//
...
//
//	public RenderPIDSold(BlockEntityRenderDispatcher dispatcher, int maxArrivals, float startX, float startY, float startZ, float maxHeight, int maxWidth, boolean rotate90, boolean renderArrivalNumber, boolean showAllPlatforms, int textColor, int firstTrainColor, float textPadding, boolean appendDotAfterMin) {
//		super(dispatcher);
...
//	}
//
//	public RenderPIDSold(BlockEntityRenderDispatcher dispatcher, int maxArrivals, float startX, float startY, float startZ, float maxHeight, int maxWidth, boolean rotate90, boolean renderArrivalNumber, boolean showAllPlatforms, int textColor, int firstTrainColor) {
