...
public class SoundOutsideAmbience extends BlockExtension {

	public SoundOutsideAmbience(BlockSettings settings) {
		super(settings);
	}
	...
	public void scheduledTick2(BlockState state, ServerWorld world, BlockPos pos, Random random) {
		world.playSound(
				...
				SoundEvents.SOUND_EVENT_OUTSIDE_AMBIENT.get(), // The sound that will play
		...
		scheduleBlockTick(new World(world.data), pos, state.getBlock(), 8040);
	}
