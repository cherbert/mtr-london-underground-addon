...
public class MordenSignOverground extends BlockRoundelBase {

	public MordenSignOverground(BlockSettings settings) {
		super(settings);
	}
	...
	public BlockEntityExtension createBlockEntity(BlockPos pos, BlockState state) {
		return new MordenSignOverground.TileEntityMordenSignOverground(pos, state);
	}
	...
	public static class TileEntityMordenSignOverground extends TileEntityBlockRoundelBase {

		public TileEntityMordenSignOverground(BlockPos pos, BlockState state) {
			super(BlockEntityTypes.MORDEN_SIGN_TILE_ENTITY_OVERGROUND.get(), pos, state);
		}
